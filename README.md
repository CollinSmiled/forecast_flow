...
The versioned forecast-run event, BigQuery row mapping, cold-path event
processor, and dual-topic Kafka consumer exist. The runnable cold-path service,
BigQuery writer/deployment, and analytics models are not finished yet.
